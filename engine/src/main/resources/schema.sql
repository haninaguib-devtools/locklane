...
-- existed, or by an unauthenticated attach (still possible until #50 requires auth
-- on the WebSocket endpoint itself) — treated as unclaimed, visible/attachable by
-- any authenticated user, rather than orphaned.
