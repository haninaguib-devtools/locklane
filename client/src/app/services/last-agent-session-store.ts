...
/**
 * Which agent session a project's entry points (sidenav "+", project summary
 * button) should jump back into (#221): the session id the user most recently
 * selected in {@link ProjectAgentSessionComponent}, keyed by project id. Client-only
 ...
 * opinion here; callers fall back to picking an agent session some other way.
 */
@Injectable({ providedIn: 'root' })
export class LastAgentSessionStore {
