...
/**
 * Which agent session tab was last active for a given issue, remembered
 ...
 * open. Written by both the agent session tab bar and the header picker.
 */
@Injectable({ providedIn: 'root' })
export class ActiveAgentSessionStore {
