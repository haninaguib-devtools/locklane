...
describe('AgentSessionsService', () => {
  ...
  beforeEach(() => {
    ...
    service = TestBed.inject(AgentSessionsService);
  ...
  it('lists open agent sessions from GET /api/projects/{projectId}/consoles', () => {
  ...
  it('reveals an agent session in the file manager via POST /api/projects/{projectId}/consoles/{id}/reveal-in-file-manager (#441)', () => {
  ...
  it('starts an agent session\'s IDE via POST /api/projects/{projectId}/consoles/{id}/open-ide, naming the IDE (#628, #782)', () => {
    service
  ...
  it('notifies onClosed subscribers when an agent session is closed', () => {
    let notified = false;
