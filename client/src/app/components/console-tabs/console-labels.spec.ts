...
describe('labelConsoles', () => {
  ...
  it('indexes from the second console of a location on', () => {
    const tabs = labelConsoles([
      { id: '7-main-a1b2c3d4', agent: 'claude' },
      { id: '7-main-e5f6a7b8', agent: 'shell' },
      { id: '7-rename-toggle', agent: 'codex' },
    ]);
  ...
  it('omits the agent when it is unknown', () => {
    const tabs = labelConsoles([{ id: '7-rename-toggle', agent: null }]);
